...
### 2. Permissions & Scope Boundaries
- [ ] `test_cross_project_role_cannot_approve`: User holding approval role in Project A CANNOT approve tasks or packets in Project B.
...
### 6. Two-Layer Review & Credit Provenance
...
### 7. Rights Attestations & Requirements
